...
export 'package:shapeup/domain/entities/macro_norms_entity.dart' show MacroNormsEntity;

class NutritionCalculationUseCase {
  ...
  static MacroNormsEntity dailyNorms({
    required Sex sex,
    required Goal goal,
