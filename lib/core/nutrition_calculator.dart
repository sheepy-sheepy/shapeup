...
class NutritionCalculator {
  ...
  static double bodyFatPercent({
    ...
    final result = roundTo2(rawResult);
  ...
  static MacroNorms dailyNorms({
    ...
    final proteins = roundTo2((calories * proteinShare) / 4);
    final fats = roundTo2((calories * fatShare) / 9);
    final carbs = roundTo2((calories * carbShare) / 4);
