...
const String analyticsRepositoryNotConnectedMessage =
    'AnalyticsRepository должен быть подключен в data-слое';
const String homeRepositoryNotConnectedMessage =
    'HomeRepository должен быть подключен в data-слое';
const String onboardingRepositoryNotConnectedMessage =
    'OnboardingRepository должен быть подключен в data-слое';
const String splashRepositoryNotConnectedMessage =
    'SplashRepository должен быть подключен в data-слое';
