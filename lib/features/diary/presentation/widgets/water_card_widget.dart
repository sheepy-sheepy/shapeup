...
import 'package:shapeup/features/diary/presentation/widgets/water_animation_widget.dart';
import 'package:shapeup/features/diary/providers/diary_provider.dart';

class WaterCardWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WaterCardWidget> createState() => _WaterCardState();
}

class _WaterCardState extends ConsumerState<WaterCardWidget> {
  ...
  @override
  void didUpdateWidget(covariant WaterCardWidget oldWidget) {
  ...
  double? _waterInputMl() {
    return ref.read(diaryControllerProvider).positiveWaterVolumeFromText(
  ...
  Future<void> _changeWater({required bool increase}) async {
    ...
    final clamped = await ref.read(diaryControllerProvider).changeWater(
        ...
        child: Column(
          ...
          children: [
            ...
            if (waterNorm != null) ...[
              ...
              AnimatedProgressBarWidget(value: waterProgress),
