...
import 'package:shapeup/features/settings/domain/repositories/profile_repository.dart' as domain;
...
class ProfileRepositoryImpl implements domain.ProfileRepository {
  ProfileRepositoryImpl(this.db, this.client, this.auth);
  ...
  @override
  Future<LocalUserEntity?> getCurrentLocalUser() async {
  ...
  Future<BodyMeasurementEntity?> _latestLocalMeasurement(String userId) async {
  ...
  Future<BodyMeasurementEntity?> _localMeasurementForDay(
    String userId,
    String dayKey,
  ) async {
...
class _ProfileBodyValues {
  ...
  factory _ProfileBodyValues.fromLocal(BodyMeasurementEntity measurement) {
